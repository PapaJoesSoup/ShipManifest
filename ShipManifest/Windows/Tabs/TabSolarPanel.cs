    ...
    internal static void Display(Vector2 displayViewerPosition)
    {
      ...
      try
      {
        ...
        foreach (var iPanel in SMAddon.SmVessel.SolarPanels)
        {
          ...
          var open = !(iPanel.PanelState == ModuleDeployableSolarPanel.panelStates.RETRACTED || iPanel.PanelState == ModuleDeployableSolarPanel.panelStates.RETRACTING || iPanel.PanelState == ModuleDeployableSolarPanel.panelStates.BROKEN);
