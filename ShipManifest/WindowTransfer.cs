  ...
  internal static class WindowTransfer
  {
    ...
    internal static void Display(int windowId)
    {
      ...
      try
      {
        ...
        TextBetweenViewers(SMAddon.smController.SelectedPartsSource, SMAddon.XFERDirection.SourceToTarget);
        ...
        TextBetweenViewers(SMAddon.smController.SelectedPartsTarget, SMAddon.XFERDirection.TargetToSource);
    ...
    internal static void SourceTransferViewer()
    {
      try
      {
        ...
        if (ShowSourceVessels && CanShowVessels())
          VesselTransferViewer(SMAddon.smController.SelectedResources, SMAddon.XFERDirection.SourceToTarget, SourceTransferViewerScrollPosition);
        else
          PartsTransferViewer(SMAddon.smController.SelectedResources, SMAddon.XFERDirection.SourceToTarget, SourceTransferViewerScrollPosition);
    ...
    private static void SourceDetailsViewer()
    {
      try
      {
        ...
        if (SMAddon.smController.SelectedResources.Contains("Crew"))
        {
          CrewDetails(SMAddon.smController.SelectedPartsSource, SMAddon.smController.SelectedPartsTarget, SMAddon.XFERDirection.SourceToTarget, SourceDetailsViewerScrollPosition);
        }
        ...
        {
          // resources are left....
          ResourceDetails(SMAddon.smController.SelectedPartsSource, SMAddon.smController.SelectedPartsTarget, SMAddon.XFERDirection.SourceToTarget, SourceDetailsViewerScrollPosition);
        }
        GUILayout.EndVertical();
        GUILayout.EndScrollView();
      }
    ...
    private static void TargetTransferViewer()
    {
      try
      {
        ...
        if (ShowTargetVessels && CanShowVessels())
          VesselTransferViewer(SMAddon.smController.SelectedResources, SMAddon.XFERDirection.TargetToSource, TargetTransferViewerScrollPosition);
        else
          PartsTransferViewer(SMAddon.smController.SelectedResources, SMAddon.XFERDirection.TargetToSource, TargetTransferViewerScrollPosition);
    ...
    private static void TargetDetailsViewer()
    {
      try
      {
        ...
        if (SMAddon.smController.SelectedResources.Contains("Crew"))
        {
          CrewDetails(SMAddon.smController.SelectedPartsTarget, SMAddon.smController.SelectedPartsSource, SMAddon.XFERDirection.TargetToSource, TargetDetailsViewerScrollPosition);
        }
        else if (SMAddon.smController.SelectedResources.Contains("Science"))
        {
        ...
        {
          ResourceDetails(SMAddon.smController.SelectedPartsTarget, SMAddon.smController.SelectedPartsSource, SMAddon.XFERDirection.TargetToSource, TargetDetailsViewerScrollPosition);
        }
        // --------------------------------------------------------------------------
        GUILayout.EndVertical();
        GUILayout.EndScrollView();
    ...
    private static void TransferResources(List<Part> source, List<Part> target)
    {
      try
      {
        ...
        if (SMSettings.RealismMode)
        {
          ...
          SMAddon.XferMode = source == SMAddon.smController.SelectedPartsSource ? SMAddon.XFERDirection.SourceToTarget : SMAddon.XFERDirection.TargetToSource;
    ...
    private static string GetResourceDescription(List<string> SelectedResources, Part part)
    {
      ...
      {
        strDescription = Utilities.GetPartCrewCount(part).ToString() + " - " + part.partInfo.title;
      }
